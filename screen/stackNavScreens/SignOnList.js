    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView>
                ...
                <List.Section title="Regatta" titleStyle={{fontSize : 23, fontWeight : "bold", color:"#222"}}>
                ...
                <List.Section title="Frostbite" titleStyle={{fontSize : 23, fontWeight : "bold", color:"#222"}}>
